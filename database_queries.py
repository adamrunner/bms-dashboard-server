...
def get_telemetry_data(hours: float = 1) -> List[Dict]:
...
def get_pack_voltage_data(hours: float = 1) -> List[Dict]:
...
def get_cell_voltage_data(hours: float = 1) -> List[Dict]:
...
def get_temperature_data(hours: float = 1) -> List[Dict]:
...
def get_soc_and_capacity_data(hours: float = 1) -> List[Dict]:
...
def get_statistics(hours: float = 24) -> Dict:
...
def get_recent_data_for_websocket(limit: int = 50) -> List[Dict]:
